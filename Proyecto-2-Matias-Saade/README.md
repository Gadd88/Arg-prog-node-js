...
- Request:
  - Parámetros requeridos del BODY:
    - nombre=Biblioteca  *(tipo: string. Establece el valor del nombre)* 
...
- Request:
  - Parámetro obligatorio de tipo URL:
    - 15 *(tipo: integer. Indica el código del mueble que se requiere modificar)*
  - Parámetros requeridos del BODY:
    - nombre=Estantería  *(tipo: string. Establece el valor del nombre)* 
    - precio=985.05      *(tipo: integer. Establece el valor del precio)* 
    - categoria=Oficina  *(tipo: decimal. Establece el valor del categoría)* 
- Response:
...
- Request:
  - Parámetro obligatorio de tipo URL:
    - 10 *(tipo: integer. Indica el código del mueble que se requiere eliminar)*
- Response:
